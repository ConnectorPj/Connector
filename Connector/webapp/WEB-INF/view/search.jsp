...
<script>
	...
	imageSrc = "http://t1.daumcdn.net/localimg/localimages/07/mapapidoc/markerStar.png", SPRITE_WIDTH = 100, // 스프라이트 이미지 너비
					...
					function() {
						...
						function addMarker(position, normalOrigin, overOrigin,
							...
							var normalImage = new daum.maps.MarkerImage(
									imageSrc, imageSize), overImage = createMarkerImage(
