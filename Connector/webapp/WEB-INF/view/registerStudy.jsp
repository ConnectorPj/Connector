...
<script type="text/javascript">
	...
	function checkInsert() {
		...
		// 스터디 금액 체크
		if ($("#studyPrice").val() == "") {
			alert("스터디 금액을 정해 주세요. (숫자만)");
			return;
		}
		
		var price = $("#studyPrice").val();
		
		var num_check = /^[0-9]*$/;
		if (num_check.test(price)) {} 
		else {
	...
	<form id="registerStudyForm" enctype="multipart/form-data">
		<div class="div_reg" id="div1">
			...
			<div id="css_tabs">
				...
				<!-- 라벨 : 화면에 표시되는 탭 제목 -->
				<label for="tab1" id="categoryLabel">웹개발</label> <label for="tab2"
					id="categoryLabel">시스템개발</label> <label for="tab3"
					id="categoryLabel">모바일개발</label> <label for="tab4"
			...
			<div class="subTimediv">
				...
				<div>
					...
					<div class="endTime clear_after">
						...
						<h4>종료시간</h4>
						<div class="toggle-button toggle-button--aava">
							<input id="endTimeAmPm" type="checkbox" value="오전"> <label
		...
		<div class="div_reg clear_after"
			...
			<div
				style="display: inline-block; margin: 100px auto 0; width: 100%;">
			...
			<div
				style="text-align: center; inline-block; margin: 10px auto 50px;">
