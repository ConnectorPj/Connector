      ...
      <div style="display:block;">
         <div class="detail">
            <div class="detail-col1">
               ...
               <div style="color: skyblue; padding: 7px 0px;">12주</div>
               <div>(3개월 주1회)</div>
            </div>
            <div class="detail-col2">
               <div style="color: skyblue; padding: 7px 0px;">분당-서현역</div>
               <div>단기간에 언어 습득</div>
            </div>
            <div class="detail-col3">
               <div style="padding: 7px 0px;">A그룹 (토)</div>
               <div>11:00 ~ 13:00</div>
            </div>
         </div>
         <hr />
         ...
         <div class="container">
            ...
            <div class="container-right">
               <div>
                  <img class="image-wrap clear_after"
                     src="/resources/images/image.jpg"
                     style="width: 40px; height: 40px;" />
               </div>
               <div id="text-tail"></div>
               <div id="text">스터디를 신청한 목적은 무엇인가요?</div>
               <br />
               <textarea class="form-control col-sm-5 ta" rows="3"
                  placeholder="내용을 입력해주세요."
                  style="resize: none; margin: 20px 0 20px;"></textarea>

               <div>
                  <img class="image-wrap" src="/resources/images/img.jpg"
                     style="width: 40px; height: 40px;" />
               </div>
      ...
      <div>
         ...
         <div id="section-right">
            <div id="nicepay">
               ...
               <div id="nicepay-right">NICEPAY에서 제공하는 안전 결제 서비스입니다. 결제 카드
                  정보는 안전한 나이스페이 전자결제 서비스에 직접 등록되며, 코넥터 서버에 별도로 저장되지 않습니다.</div>
            </div>
         ...
         <div id="section-right">
			...
			<button href="applicationSuccess.do" class="btn btn-primary btn-lg raised end" style="margin-top:70px;">다음으로</button>
      </div>
